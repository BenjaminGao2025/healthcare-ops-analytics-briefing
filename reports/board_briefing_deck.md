# Board Briefing Deck Source

## Slide 1: Executive Summary

- Largest BC vs Canada gap: MRI Scan (+29.3 days).
- Longest VCH median wait: Dental Surgery (226.1 days).
- Main reporting caveat: BC_MoH null case-volume rows (9,688 rows).
